...
public class ProfileCommand implements Command {
    ...
    public ProfileCommand(UserService userService, AppointmentService appointmentService) {
    ...
    public String execute(HttpServletRequest request) {
        ...
        final List<Appointment> appointmentsOfClient = appointmentService.findAppointmentsOfClient(user);
